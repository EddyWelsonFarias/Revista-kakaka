...
<?php
            session_start();
            //var_dump($_SESSION['id_usuarioComentario']);
...
<main role="main">
  ...
  <section class="jumbotron text-center " style="background-image: url('img/series.jpg') ;">
    <div class="container">
 ...
 <div>
  ...
  <ol class="breadcrumb" style="font-size: 20px;">
   ...
   <?php
      ...
      $query = "SELECT noticia.id_noticia, noticia.titulo, noticia.subtitulo, noticia.noticia,noticia.publicado, noticia.atualizado, noticia.imagem, noticia.id_usuario, categoria.categoria FROM categoria, noticia, categoria_noticia WHERE noticia.id_noticia = categoria_noticia.id_noticia AND categoria.id_categoria = categoria_noticia.id_categoria AND categoria = 'serie' ";
    ...
    // var_dump($total, $numpaginas);exit;
      ...
      $inicioExibir = ($exibir * $paginacao) - $exibir;
       ...
       $query2 = "SELECT noticia.id_noticia, noticia.titulo, noticia.subtitulo, noticia.noticia, noticia.publicado, noticia.atualizado, noticia.imagem, noticia.id_usuario, categoria.categoria FROM categoria, noticia, categoria_noticia WHERE noticia.id_noticia = categoria_noticia.id_noticia AND categoria.id_categoria = categoria_noticia.id_categoria AND categoria = 'serie' order by noticia.publicado desc limit $inicioExibir, $exibir";
